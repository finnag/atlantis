...
func (g *GithubAppWorkingDir) Clone(log logging.SimpleLogging, headRepo models.Repo, p models.PullRequest, safeToMerge bool, workspace string) (string, bool, error) {
	baseRepo := &p.BaseRepo
	...
	return g.WorkingDir.Clone(log, headRepo, p, safeToMerge, workspace)
}
