...
func (g *GithubAppWorkingDir) Clone(headRepo models.Repo, p models.PullRequest, workspace string, shouldRecheckUpstream bool) (string, bool, error) {
	baseRepo := &p.BaseRepo
	...
	return g.WorkingDir.Clone(headRepo, p, workspace, shouldRecheckUpstream)
}
